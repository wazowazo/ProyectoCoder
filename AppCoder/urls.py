...
urlpatterns = [
    ...
    #path('formularios',views.cursoFormularios, name='cursoFormularios'),
    #path('prof_formularios',views.profesorFormularios, name='prof_Formularios'),
    path('busquedaCamada', views.busquedaCamada, name='busquedaCamda'),
